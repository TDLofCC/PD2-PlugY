...
* Updated: Season 13
* Author: BetweenWalls / Kanzeon (post-Season 9) / TDLofCC (Season 12/13)
...
Includes several developer-style cube recipes to assist in testing:
  ...
  * roll specific corruption modifiers with key and a rune: runes #1-10 are for low-tier mods, runes #11-20 are for mid-tier mods, and runes #21-30 are for high-tier mods (see [wiki](https://wiki.projectdiablo2.com/wiki/Corruptions#Equipment_Corruptions) for order)
